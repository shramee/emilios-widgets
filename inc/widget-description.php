...
/**
 * Class Widget_Wixbu_Course_Description
 */
class Widget_Wixbu_Course_Description extends WP_Widget {
	/** Basic Widget Settings */
	const WIDGET_NAME = "Course description";
	const WIDGET_DESCRIPTION = "Displays course description text in sidebar.";
	var $textdomain;
	var $fields;

	public static function register_widget() {
		register_widget("Widget_Wixbu_Course_Description");
	}
